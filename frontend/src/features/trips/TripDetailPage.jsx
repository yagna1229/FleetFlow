...
export default function TripDetailPage() {
    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            toast.success('Trip completed! Driver & vehicle released back to AVAILABLE.')
        ...
        <div className="tripWrap">
            ...
            <div className="tripLifecycle">
                ...
                {trip.status === 'CANCELLED' && (
                    <>
                        ...
                        <span className="tripStep" style={{ background: 'rgba(239,68,68,0.08)', borderColor: 'rgba(239,68,68,0.3)', color: '#dc2626' }}>CANCELLED</span>
                    </>
                )}
            </div>
                ...
                <div className="dashSection">
                    ...
                    <div className="tripInfoGrid">
                        <div className="tripInfoCard">
                            ...
                            <div className="tripInfoValue">{trip.vehicle.make} {trip.vehicle.model}</div>
                        </div>
                        <div className="tripInfoCard">
                            <div className="tripInfoLabel">Registration</div>
                            <div className="tripInfoValue">{trip.vehicle.registration_number}</div>
                        </div>
                        <div className="tripInfoCard">
                        ...
                        <div className="tripInfoCard">
                            ...
                            <div className="tripInfoValue"><StatusPill status={trip.vehicle.status} /></div>
                        </div>
                        <div className="tripInfoCard">
                            <div className="tripInfoLabel">Capacity</div>
                            <div className="tripInfoValue">{formatNumber(trip.vehicle.max_capacity_kg)} kg</div>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="dashSection">
                    ...
                    <div className="tripInfoGrid">
                        ...
                        <div className="tripInfoCard">
                            ...
                            <div className="tripInfoValue">{trip.driver.license_number} ({trip.driver.license_category})</div>
                        </div>
                        <div className="tripInfoCard">
                            <div className="tripInfoLabel">Driver Status</div>
                            <div className="tripInfoValue"><StatusPill status={trip.driver.status} /></div>
                        </div>
                        <div className="tripInfoCard">
                            <div className="tripInfoLabel">Safety Score</div>
                            <div className="tripInfoValue">{Number(trip.driver.safety_score)}%</div>
                        </div>
                    </div>
                </div>
            )}
            ...
            <Modal isOpen={showDispatch} onClose={() => setShowDispatch(false)} title="Dispatch Trip">
                <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: 16 }}>
                    Dispatching will set the driver and vehicle status to <strong>ON_TRIP</strong>.
                </p>
            ...
            <Modal isOpen={showComplete} onClose={() => setShowComplete(false)} title="Complete Trip">
                <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: 16 }}>
                    Completing will release the driver and vehicle back to <strong>AVAILABLE</strong>.
                </p>
                <div className="formGroup">
