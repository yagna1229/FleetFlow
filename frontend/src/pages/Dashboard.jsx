  ...
  return (
    <div className="dashWrap">
      ...
      <div className="pageHeader">
        <div>
          ...
          <p className="pageSubtitle">
            {roleMeta.icon} Logged in as <strong>{roleMeta.label}</strong> —{" "}
      ...
      <div className="kpiGrid">
        ...
        <div
          className="kpiCard kpiBrand"
          onClick={() =>
            canAccess(role, "/vehicles") && navigate(ROUTES.VEHICLES)
          }
          style={{
            cursor: canAccess(role, "/vehicles") ? "pointer" : "default",
          }}
        >
        ...
        {(role === ROLES.MANAGER || role === ROLES.SAFETY_OFFICER) && (
          <div
            className="kpiCard kpiWarning"
            onClick={() =>
              canAccess(role, "/maintenance") && navigate(ROUTES.MAINTENANCE)
            }
            style={{
              cursor: canAccess(role, "/maintenance") ? "pointer" : "default",
            }}
          >
            <div className="kpiIcon">🔧</div>
        ...
        {(role === ROLES.MANAGER || role === ROLES.FINANCIAL_ANALYST) && (
          <div className="kpiCard kpiSuccess">
            ...
            <div className="kpiValue">
              {formatNumber(kpis.utilization_rate, 1)}%
            </div>
