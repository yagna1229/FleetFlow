    ...
    <div className="vehicleDetail">
      <div className="pageHeader">
        <div>
          ...
          <p className="pageSubtitle">
            {vehicle.model || vehicle.vehicle_type} — {vehicle.license_plate}
          </p>
        </div>
        <div style={{ display: "flex", gap: "8px" }}>
          ...
          {role === "manager" && vehicle.status !== "RETIRED" && (
            <button className="dangerBtn" onClick={handleRetire}>
              Retire Vehicle
            </button>
          )}
        </div>
      ...
      <div className="vehicleInfoGrid">
        <div className="vehicleInfoItem">
          ...
          <div className="vehicleInfoValue">
        ...
        <div className="vehicleInfoItem">
          ...
          <div className="vehicleInfoValue">
            <code>{vehicle.license_plate}</code>
          </div>
        </div>
        <div className="vehicleInfoItem">
          <div className="vehicleInfoLabel">Max Capacity</div>
          <div className="vehicleInfoValue">
            {formatNumber(vehicle.max_capacity_kg)} kg
          </div>
        </div>
        <div className="vehicleInfoItem">
        ...
        {vehicle.acquisition_cost !== undefined &&
