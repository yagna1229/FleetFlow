...
export const fetchTrips = createAsyncThunk('trips/fetchAll', async (params = {}) => {
...
export const fetchTripDetail = createAsyncThunk('trips/fetchDetail', async (id) => {
...
export const dispatchTrip = createAsyncThunk('trips/dispatch', async ({ id, data }, { rejectWithValue }) => {
    try {
...
export const completeTrip = createAsyncThunk('trips/complete', async ({ id, data }, { rejectWithValue }) => {
    try {
...
export const cancelTrip = createAsyncThunk('trips/cancel', async (id, { rejectWithValue }) => {
    try {
