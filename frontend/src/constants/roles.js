...
export const ROLE_META = {
  [ROLES.MANAGER]: {
    ...
    icon: "🏗️",
    description:
      "Full access — vehicles, drivers, trips, maintenance, expenses, analytics",
  },
  [ROLES.DISPATCHER]: {
    label: "Dispatcher",
    icon: "📦",
  ...
  [ROLES.SAFETY_OFFICER]: {
    ...
    icon: "🛡️",
    description:
      "Monitor driver compliance, license expirations, safety scores",
  },
...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.DISPATCHER]: ["/dashboard", "/trips", "/vehicles", "/drivers"],
  [ROLES.SAFETY_OFFICER]: ["/dashboard", "/drivers", "/trips"],
  [ROLES.FINANCIAL_ANALYST]: [
    "/dashboard",
    "/expenses",
    "/analytics",
